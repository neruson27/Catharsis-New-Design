						...
						if (is_home()) { ?>
							<span class="logos">
								<a title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?> - <?php echo esc_attr(get_bloginfo('description', 'display')); ?>"
									itemprop="url" href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo $logo; ?>"
										width="195" height="50"
										alt="<?php echo esc_attr(get_bloginfo('name', 'display')); ?> - <?php echo esc_attr(get_bloginfo('description', 'display')); ?>"><span
										class="hdl"><?php echo esc_attr(get_bloginfo('name', 'display')); ?></span></a>
							</span>
						<?php } else { ?>
							<span class="logos">
								<a title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?> - <?php echo esc_attr(get_bloginfo('description', 'display')); ?>"
			...
			<div class="searchx minmb">
				<form action="<?php bloginfo('url'); ?>/" id="form" method="get" itemprop="potentialAction" itemscope
					...
					<input id="s" itemprop="query-input" class="search-live" type="text"
						placeholder="<?php echo GOV_lang::get('search_placeholder') ?>" name="s" />
